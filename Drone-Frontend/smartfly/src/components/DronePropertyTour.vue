        ...
        <v-row>
          ...
          >
            <v-card 
              ...
              :hover="true"
            >
              <!-- v-hover v-slot="{ hover }" -->n
                <v-card-media :height="280">
                  ...
                  >
                    ...
                    <p class="mt-4">Video en producción</p>
                  </v-sheet>
                  ...
                  <!-- Superposición degradada para mejor contraste -->
    ...
    <v-dialog v-model="propertyModal" max-width="1200" scrollable>
      <v-card v-if="selectedProperty" class="property-modal">
        <v-card-actions class="justify-end">
          <v-btn icon @click="propertyModal = false">
        ...
        <v-row no-gutters>
          <v-col cols="12" md="8">
            <v-sheet
              v-if="!selectedProperty.video"
              height="500"
              color="rgba(10, 25, 47, 0.7)"
              class="d-flex flex-column justify-center align-center"
            >
              <v-icon size="64" color="rgba(255, 255, 255, 0.7)">mdi-video-wireless</v-icon>
              <p class="mt-4">Contenido profesional en producción</p>
            </v-sheet>
          ...
          <v-col cols="12" md="4" class="modal-info">
            <v-card-text>
              ...
              <v-list dense>
                <v-list-item>
                  <v-list-item-icon>
                    <v-icon small>mdi-drone</v-icon>
                  </v-list-item-icon>
                  <v-list-item-content>
                    <strong>Dron:</strong> {{ selectedProperty.drone }}
                  </v-list-item-content>
                </v-list-item>
                <v-list-item>
                  <v-list-item-icon>
                  ...
                  <v-list-item-content>
                    <strong>Cámara:</strong> {{ selectedProperty.camera }}
                  </v-list-item-content>
                </v-list-item>
              </v-list>
...
.property-card:hover {
  ...
  box-shadow: 0 20px 40px rgba(0, 247, 255, 0.2) !important;
}
